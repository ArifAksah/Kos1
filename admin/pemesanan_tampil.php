...
<table width="850" border="0" cellpadding="2" cellspacing="1" class="table-list" >
  <tr>
    ...
    <th width="10%" align="right" bgcolor="#CCCCCC"><font color="#FF0066"><strong>Bukti Pembayaran </strong></font></th>
  ...
  while ($myData =mysql_fetch_array($myQry)) {
    ...
    $konfirmasi="SELECT * from konfirmasi";
  ...
  <tr>
    ...
    <?php 
    echo "<td><img src='../".$myKonfirmasi['gambar']."' width='100' height='100'></td>"; 
    ?>
    <td align="center">
