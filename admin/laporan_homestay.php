...
?>
<h2><font color="#FF0066"> LAPORAN DATA KOS </font></h2>
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
  <table  class="table-list"  width="400" border="0" cellpadding="2" cellspacing="1">
    <tr>
      <th colspan="2" bgcolor="#CCCCCC"><font color="#FF0066"><strong>KATEGORI KOS </strong></font></th>
    </tr>
    <tr>
...
<table class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <td width="470" bgcolor="#CCCCCC"><font color="#FF0066"><strong>Nama Kos </strong></font></td>
